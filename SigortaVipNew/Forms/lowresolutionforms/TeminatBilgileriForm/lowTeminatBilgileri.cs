...
{
    public partial class lowTeminatBilgileri : UserControl
    {
        ...
        private void odemeAyarla(string deger)
        {
            if (veriler.Length > 0)
            {
                foreach (lowtableRows item in veriler)
                {
        ...
        private void sorguIcinKaydet()
        {
            ...
            foreach (lowtableRows row in tablePanel.Controls)
            {
        ...
        private void btnSifirla_Click(object sender, EventArgs e)
        {
            ...
            AveonSigortaTeminat.TeminatVarMi = false;
            ...
            AnadoluSigortaTeminat.TeminatVarMi = false;
        ...
        private void pnlConfig3_Paint(object sender, PaintEventArgs e)
        {

        }

        private void chbDeprem_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void chbSel_CheckedChanged(object sender, EventArgs e)
        {
        ...
        public void sorgu()
        {
            lowTableUserControl tablo = new lowTableUserControl();
            tablo.Dock = DockStyle.Fill;
            pnlTable.Controls.Clear();
            pnlTable.Controls.Add(tablo);

            veriler = this.Controls.Find("lowtableRows", true);
