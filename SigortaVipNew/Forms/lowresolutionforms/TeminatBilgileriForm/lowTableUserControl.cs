...
{
    public partial class lowTableUserControl : UserControl
    {
        ...
        private void checkScroolBar()
        {
            ...
            {
                if (item.GetType().Equals(typeof(lowtableRows)))
                    count++;
            }
            if (count > 15)
                tblHeader.Padding = new Padding(0, 0, 10, 0);
            else
        ...
        private void getData()
        {
            ...
            //    {
            //        lowtableRows teminatSatir = new lowtableRows();
